    ...
    <>
      ...
      <ul className={`menu-nav ${layoutProps.ulClasses}`}>
        ...
        <li
          ...
          data-menu-toggle="hover"
        >
          <NavLink className="menu-link menu-toggle" to="/it-asset-management">
            <span className="svg-icon menu-icon">
              <SVG src={toAbsoluteUrl("/media/svg/icons/Shopping/Bag2.svg")} />
            </span>
            <span className="menu-text">IT Asset Management</span>
          </NavLink>
          <div className="menu-submenu">
            <i className="menu-arrow" />
            <ul className="menu-subnav">
              ...
              <li
                ...
                aria-haspopup="true"
              >
                <NavLink className="menu-link" to="/it-asset-management/customers">
                  <i className="menu-bullet menu-bullet-dot">
                    <span />
                  </i>
                  <span className="menu-text">Customers</span>
              ...
              <li
                ...
                aria-haspopup="true"
              >
                <NavLink className="menu-link" to="/it-asset-management/products">
                  <i className="menu-bullet menu-bullet-dot">
                    <span />
                  </i>
                  <span className="menu-text">Products</span>
